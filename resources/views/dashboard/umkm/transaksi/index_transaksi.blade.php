                    ...
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-200">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Jumlah Pesanan</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($transaksi as $s)
                                <tr class="hover:bg-gray-100 transition duration-300">
                                    ...
                                    <td class="px-6 py-4">{{ $s->jumlah }}</td>
                                    <td class="px-6 py-4">{{ $s->email }}</td>
                                    <td class="px-6 py-4 text-center space-x-2">
                                        <!-- Tombol View -->
                                        <a href="{{ route('admin.detail.transaksi', ['id_umkm' => $s->id_umkm, 'id_transaksi' => $s->id_transaksi]) }}"
